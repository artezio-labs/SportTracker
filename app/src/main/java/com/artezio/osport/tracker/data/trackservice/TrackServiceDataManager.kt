...
class TrackServiceDataManager @Inject constructor(
    private val insertLocationDataUseCase: InsertLocationDataUseCase,
    private val insertPedometerDataUseCase: InsertPedometerDataUseCase,
    ...
    fun insertPedometerData(pedometerData: PedometerData) = scope.launch {
        insertPedometerDataUseCase.execute(pedometerData)
    }

    fun insertLocationData(locationPointData: LocationPointData) = scope.launch {
        insertLocationDataUseCase.execute(locationPointData)
    }
